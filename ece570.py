...
def main():
    # Run command:
    # python -u main_PrAC_imp.py --data data/cifar100 --dataset cifar100 --arch res56s --split_file npy_files/cifar100-train-val.npy --batch_size 128 --lr 0.1 --pruning_times 16 --eb_eps 0.08 --prune_type rewind_lt --rewind_epoch 2 --threshold 0 --save_dir PrAC_lt_cifar100_res56s > PrAC_lt_cifar100_res56s/output.log
    # python -u main_PrAC_imp.py --data data/mnist --dataset mnist --arch res56s --split_file npy_files/mnist-train-val.npy --batch_size 128 --lr 0.1 --pruning_times 16 --eb_eps 0.08 --prune_type rewind_lt --rewind_epoch 2 --threshold 0 --save_dir PrAC_lt_mnist_res56s > PrAC_lt_mnist_res56s/output.log
